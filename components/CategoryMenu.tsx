...
const categoryInfo: Record<DisabilityCategory, { title: string; icon: JSX.Element }> = {
  visual: {
...
const ChoiceButton: React.FC<{ onClick: () => void; title: string; description: string; icon: JSX.Element }> = ({ onClick, title, description, icon }) => (
  <button
    onClick={onClick}
    ...
    <section aria-labelledby="category-menu-title">
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        ...
        <ChoiceButton
          ...
          icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>}
        />
      </div>
    </section>
  );
